...
public final class MethodSpecTest {
  ...
  @Test public void generateLambda(){
    MethodSpec methodSpec = MethodSpec.methodBuilder("")
            .addParameter(String.class,"para1")
            .addParameter(String.class,"para2")
            .addStatement("$N += $N","para1","para2")
            .addStatement("return $N","para1")
            .build();
    assertThat(methodSpec.toString()).isEqualTo("" +
            "(para1, para2) -> {\n" +
            "  para1 += para2;\n" +
  ...
  @Test public void generateLambdaAsParameter(){
    MethodSpec methodSpec = MethodSpec.methodBuilder("")
            .addParameter(String.class,"b")
            .addStatement("b.name($S)","some name")
            .build();
    CodeBlock codeBlock = CodeBlock.builder()
            .addStatement("$L.register($L)", "manager", methodSpec)
            .build();
